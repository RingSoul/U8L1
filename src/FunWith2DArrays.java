public class FunWith2DArrays
{
    ...
    {
        int rowLen = strArray.length;
        int columnLen = strArray[0].length;
        String topLeft = strArray[0][0];
        String topRight = strArray[0][columnLen - 1];
        String bottomLeft = strArray[rowLen - 1][0];
        String bottomRight = strArray[rowLen - 1][columnLen - 1];
